...
class GridFsStorage extends node_events_1.EventEmitter {
    ...
    static _mergeProps(extra, fileSettings) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const previous = yield (fileSettings.filename ? {} : GridFsStorage.generateBytes());
    ...
    fromMulterStream(readStream, request, file) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                ...
                const hash = computeMd5 ? node_crypto_1.default.createHash('md5') : null;
                readStream.on('data', (chunk) => hash === null || hash === void 0 ? void 0 : hash.update(chunk));
                const emitFile = (f) => {
                    const storedFile = {
                        id: f._id,
                        filename: f.filename,
    ...
    _connect() {
        ...
        if (db && !(0, is_promise_1.default)(db)) {
            this._setDb(db);
            return;
        }
    ...
    _createConnection() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { cache } = GridFsStorage;
            try {
                const { db } = yield this._openConnection(url, options);
                if (this.caching) {
    ...
    _setDb(db) {
        ...
        const client = (_b = (_a = this.db) === null || _a === void 0 ? void 0 : _a.client) !== null && _b !== void 0 ? _b : null;
        ...
        process.nextTick(() => {
            var _a, _b;
            this.emit('connection', { db: this.db, client: (_b = (_a = this.db) === null || _a === void 0 ? void 0 : _a.client) !== null && _b !== void 0 ? _b : null });
        });
    }
    /**
