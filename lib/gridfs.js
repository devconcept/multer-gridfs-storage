...
class GridFsStorage extends node_events_1.EventEmitter {
    ...
    _updateConnectionStatus() {
        ...
        if (this.client) {
            ...
            this.connected = (_c = (_b = (_a = this.client.topology) === null || _a === void 0 ? void 0 : _a.isConnected) === null || _b === void 0 ? void 0 : _b.call(_a)) !== null && _c !== void 0 ? _c : true;
            return;
        }
        // @ts-expect-error topology is not part of the public API
        this.connected = ((_e = (_d = this.db) === null || _d === void 0 ? void 0 : _d.topology) === null || _e === void 0 ? void 0 : _e.isConnected()) || true;
    }
    /**
