 ...
 *
 **/
Cache.prototype.initialize = function(opts) {
 ...
 */
Cache.prototype.findUri = function(cacheName, url) {
 ...
 */
Cache.prototype.has = function(cacheIndex) {
 ...
 */
Cache.prototype.get = function(cacheIndex) {
 ...
 */
Cache.prototype.set = function(cacheIndex, value) {
 ...
 */
Cache.prototype.isPending = function(cacheIndex) {
 ...
 */
Cache.prototype.isOpening = function(cacheIndex) {
	const cached = this.get(cacheIndex);
 ...
 */
Cache.prototype.resolve = function(cacheIndex, db, client) {
	const cached = this.get(cacheIndex);
	cached.db = db;
 ...
 */
Cache.prototype.reject = function(cacheIndex, err) {
	const cached = this.get(cacheIndex);
	cached.pending = false;
 ...
 */
Cache.prototype.waitFor = function(cacheIndex) {
 ...
 */
Cache.prototype.connections = function() {
	let total = 0;
 ...
 * @param cacheIndex {object} The index to look for
 */
Cache.prototype.remove = function(cacheIndex) {
	const {name} = cacheIndex;
	const {url} = cacheIndex;
	const {index} = cacheIndex;
