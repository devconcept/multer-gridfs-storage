...
function isFunction(target) {
  ...
  return target !== null && mayBeFunc && objClass(target) === '[object Function]';
}
...
function isGeneratorFunction(target) {
  return objClass(target) === '[object GeneratorFunction]';
}
...
function isGenerator(target) {
  ...
  return objClass(target) === '[object Generator]';
  ...
  if (isSymbolSupported) {
    ...
    // The spec says `next` is a function with no parameters but generators accept one parameter to pass values to the next call
    // Eg:
