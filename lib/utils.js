...
function isObject(target) {
  ...
  return proto.hasOwnProperty('constructor') && typeof proto.constructor === 'function' && toStr.call(Object) === toStr.call(proto.constructor);
}
...
/**
 * A function to check if a validation rule applied to a value is valid or not
 * @function checkRule
 * @static
